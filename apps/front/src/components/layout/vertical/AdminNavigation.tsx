...
import LogoAdmin from '@components/layout/shared/LogoAdmin'
...
// Styled Components
const StyledBoxForShadow = styled('div')({
  top: 50,
  left: -8,
  zIndex: 2,
  height: 75,
    ...
    >
      ...
      <NavHeader>
        ...
        {!(isCollapsed && !isHovered) && (
          <NavCollapseIcons
            lockedIcon={AdminMenuToggleSvg}
            unlockedIcon={AdminMenuToggleSvg}
      ...
      <AdminMenu scrollMenu={scrollMenu} />
    </VerticalNav>
  )
}
