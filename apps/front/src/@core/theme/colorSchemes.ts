    ...
    light: {
      palette: {
        primary: {
          ...
          lightOpacity: 'rgb(var(--mui-palette-primary-mainChannel) / 0.10)',
        ...
        error: {
          ...
          lightOpacity: 'rgb(var(--mui-palette-error-mainChannel) / 0.1)',
        ...
        warning: {
          ...
          lightOpacity: 'rgba(247, 168, 51, 0.2)',
        ...
        success: {
          ...
          lightOpacity: 'rgb(var(--mui-palette-success-mainChannel) / 0.1)',
        ...
        text: {
          ...
          secondary: `#595959`,
          disabled: `rgb(var(--mui-mainColorChannels-light) / 0.5)`,
