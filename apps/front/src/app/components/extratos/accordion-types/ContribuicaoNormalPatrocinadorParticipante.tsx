...
interface ContribuicaoNormalPatrocinadorParticipanteProps {
  item: ExtratoTypes
}

export const ContribuicaoNormalPatrocinadorParticipante: React.FC<ContribuicaoNormalPatrocinadorParticipanteProps> = ({
  item
}) => {
  return (
