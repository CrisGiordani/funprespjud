...
interface EstornoContribuicaoNormalProps {
  item: ExtratoTypes
}

export const EstornoContribuicaoNormal: React.FC<EstornoContribuicaoNormalProps> = ({ item }) => {
  return (
      ...
      <div className='w-full flex flex-col gap-1'>
        ...
        <LabelValueItemAccortion
          ...
          values={[
            ...
            {
              label: 'Estorno da FCBE',
              value: formatCurrency(Math.abs(item.fcbe))
            }
          ]}
        />
        ...
        <LabelValueItemAccortion
          ...
          values={[
            {
              label: 'Estorno da taxa de carregamento',
              value: formatCurrency(Math.abs(item.taxaCarregamento))
            }
          ]}
        />
