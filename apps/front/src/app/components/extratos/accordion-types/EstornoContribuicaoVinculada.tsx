...
interface EstornoContribuicaoVinculadaProps {
  item: ExtratoTypes
}

export const EstornoContribuicaoVinculada: React.FC<EstornoContribuicaoVinculadaProps> = ({ item }) => {
  return (
    <div className='w-full flex flex-col gap-4'>
      <div className='w-full flex flex-col gap-1'>
        ...
        <LabelValueItemAccortion
          ...
          values={[
            {
              label: 'Estorno taxa de carregamento',
