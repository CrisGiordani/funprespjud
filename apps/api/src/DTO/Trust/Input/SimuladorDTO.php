...
class SimuladorDTO
{
    ...
    #[Groups(['simulador:read'])]
    private ?int $urps = null;

    #[Groups(['simulador:read'])]
    private ?float $baseContribuicaoFunpresp = null;
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->urps = $data['urps'] ?? null;
        $this->baseContribuicaoFunpresp = $data['baseContribuicaoFunpresp'] ?? null;
    }
    ...
    public function getUrps(): ?int
    {
        return $this->urps;
    }

    public function setUrps(?int $urps): self
    {
        $this->urps = $urps;
    ...
    public function getBaseContribuicaoFunpresp(): ?float
    {
        return $this->baseContribuicaoFunpresp;
    }

    public function setBaseContribuicaoFunpresp(?float $baseContribuicaoFunpresp): self
    {
        $this->baseContribuicaoFunpresp = $baseContribuicaoFunpresp;
